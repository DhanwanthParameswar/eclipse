  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#f9fafb]">
      <div className="bg-white p-8 rounded-3xl shadow-lg w-full max-w-md flex flex-col h-[75vh]">
        {/* scrollable main content inside card */}
        <div className="flex-1 overflow-auto">
          <div className="w-full max-w-[600px] mx-auto pt-5 flex flex-col justify-start items-center gap-4">
            <div className="self-stretch h-11 flex items-center justify-between">
              <div className="flex items-center gap-3.5">
                <div
                  className="Vector cursor-pointer transition-opacity duration-200 hover:opacity-60"
                  role="button"
                  tabIndex={0}
                ...
                <div className="inline-flex flex-col justify-start items-start">
                  <div className="Heading1 self-stretch flex flex-col justify-start items-start">
                    <div className="AlexDoe justify-center text-slate-900 text-2xl font-semibold font-['Sora'] leading-6">
                      Alex Doe
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-end">
                <div className="Icon cursor-pointer transition-opacity duration-200 hover:opacity-60">
                  {/* settings svg */}
                  <svg
                    width="31"
                    height="35"
            ...
            <div className="self-stretch py-1 flex flex-col justify-start items-start">
              <div className="Label self-stretch h-11 min-w-40 flex flex-col justify-center items-start">
                <div className="self-stretch flex-1 rounded-lg inline-flex justify-start items-start">
                  <div className="BackgroundBorder self-stretch pl-3 py-px bg-transparent rounded-tl-lg rounded-bl-lg border-l border-t border-b border-slate-300 flex justify-center items-center">
                  ...
                  <div className="Input flex-1 self-stretch relative bg-transparent rounded-tr-lg rounded-br-lg border-r border-t border-b border-slate-300 overflow-hidden">
                    <input
                      ref={inputRef}
                      type="text"
                      value={search}
        ...
        {/* keep card footer spacing if needed (empty for Library) */}
        <div className="w-full" />
      </div>

      {/* floating add button remains fixed to viewport */}
      <div className="Frame2 w-[100px] h-[100px] bottom-[50px] right-[50px] fixed z-50">
        <button
          type="button"

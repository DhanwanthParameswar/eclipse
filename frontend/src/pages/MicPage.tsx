  ...
  return (
    ...
    >
      <div className="bg-white p-8 rounded-3xl shadow-lg w-full max-w-md flex flex-col h-[75vh]">
        {/* preserved mic content inside card */}
        <div className="flex-1 inline-flex flex-col justify-center items-center gap-12 overflow-hidden">
            ...
            >
              ...
              >
                <div
                  ...
                  className="Container"
                >
                  {/* svg omitted for brevity, preserved from original */}
                  <svg
                    width="32"
                    height="30"
                    viewBox="0 0 32 30"
